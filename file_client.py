...
while True:
    ...
    try:
        ...
        if recv_ack == "upload Ok":
            print("Received \"upload\" ack from the server")
            ...
            print("Received \"download\" ack from the server")
            filename_list = command_list[1].split("/")
            # file_folder = client_folder + "downloaded_file/"
            file_folder = command_list[-1]
